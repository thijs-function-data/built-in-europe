    ...
    <main style={{ padding: "8rem 0 6rem", textAlign: "center", position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center" }}>
      <section className="container" style={{ flexGrow: 1, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
        ...
        <div className="antigravity-badge animate-fade-in stagger-1">
          <span></span> June 2-4 • Global Online & Utrecht Live Finals
        </div>

        <h1 className="heading-xl animate-fade-in stagger-2" style={{ maxWidth: "1000px" }}>
          The Next Generation of <br />
          <span className="text-gradient">EU Analytics</span>
        </h1>

        <p className="text-lead animate-fade-in stagger-3">
          Build powerful, privacy-first analytics tools.
          We provide the infrastructure; you build the future—ensuring data never leaves Europe.
        </p>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", marginBottom: "6rem", flexWrap: "wrap" }} className="animate-fade-in stagger-4">
          <Link href="/tickets">
            <button className="btn btn-primary" style={{ padding: "1.125rem 2.5rem", fontSize: "1.125rem" }}>
              Register Now <svg style={{ marginLeft: "0.5rem" }} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
            </button>
          </Link>
          <Link href="/about">
      ...
      <section className="container animate-fade-in stagger-4" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "2.5rem", marginTop: "auto", width: "100%" }}>
        <div className="glass-card" style={{ textAlign: "left", display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <h3 className="heading-lg" style={{ fontSize: "1.75rem", margin: 0 }}>The Timeline</h3>
          <p style={{ color: "var(--text-secondary)", lineHeight: 1.7 }}>
            <strong style={{ color: "var(--text-primary)" }}>June 2-3</strong>: Global Online Collaboration.<br />
            <strong style={{ color: "var(--text-primary)" }}>June 4</strong>: Live Finals in Utrecht.
          </p>
        </div>
        ...
        <div className="glass-card" style={{ textAlign: "left", display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <h3 className="heading-lg" style={{ fontSize: "1.75rem", margin: 0 }}>Data Sovereignty</h3>
          <p style={{ color: "var(--text-secondary)", lineHeight: 1.7 }}>
            Build state-of-the-art tooling while guaranteeing data never leaves European borders. A technical and jurisdictional challenge.
          </p>
        </div>
      </section>
    </main>
