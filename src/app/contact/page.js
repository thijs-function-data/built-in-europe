        ...
        <main className="container" style={{ paddingTop: "4rem", paddingBottom: "4rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: "3rem", maxWidth: "1000px", margin: "0 auto" }} className="animate-fade-in stagger-2">
                ...
                <div className="glass-card" style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
                    <div>
                        <h3 className="heading-lg" style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}>Email Us</h3>
                        <p style={{ color: "var(--text-secondary)" }}>hello@builtineurope.eu</p>
                    </div>

                    <div>
                        <h3 className="heading-lg" style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}>The Venue</h3>
                        <p style={{ color: "var(--text-secondary)", lineHeight: 1.6 }}>
                            <strong>Relevant Online</strong><br />
                            Utrecht, The Netherlands<br />
                            (Live Finals on June 4th)
                        </p>
                    </div>

                    <div>
                        <h3 className="heading-lg" style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}>Join the Community</h3>
                ...
                <div className="glass-card" style={{ padding: "1rem", display: "flex", flexDirection: "column" }}>
                    <h3 className="heading-lg" style={{ fontSize: "1.5rem", marginBottom: "1rem", paddingLeft: "1rem", paddingTop: "0.5rem" }}>Relevant Online Office</h3>
